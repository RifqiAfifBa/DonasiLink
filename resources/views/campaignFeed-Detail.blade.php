...
<div class="content-wrapper justify-content-center d-flex flex-column align-items-center pt-5 pb-5 text-center">
    ...
    <div class="detail-footer">
        <a href="CampaignFeed" class="btn-secondary text-center" style="display: flex; justify-content: center; align-items: center; text-align: center; width: 100%;">Kembali</a>
        <a href="Checkout" class="btn-primary text-center" style="display: flex; justify-content: center; align-items: center; text-align: center; width: 100%;">Donasi Sekarang</a>
    </div>
</div>
